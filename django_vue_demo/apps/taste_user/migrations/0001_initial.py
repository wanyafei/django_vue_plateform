    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, 'STOP'), (2, 'PAUSE'), (1, 'RUNNING'), (3, 'RESUME')], default=0, verbose_name='任务状态')),
                ...
                ('env', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='env.environment', verbose_name='环境名称')),
